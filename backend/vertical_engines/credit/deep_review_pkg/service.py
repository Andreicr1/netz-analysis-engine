...
from vertical_engines.credit.deep_review_pkg.corpus import (
    _gather_deal_texts,
    _load_deal_context_from_blob,
)
from vertical_engines.credit.deep_review_pkg.helpers import (
    _async_call_openai,
    _call_openai,
    _now_utc,
...
from vertical_engines.credit.deep_review_pkg.models import _LLM_CONCURRENCY
from vertical_engines.credit.deep_review_pkg.persist import (
    _build_tone_artifacts,
    _index_chapter_citations,
)
from vertical_engines.credit.deep_review_pkg.policy import (
    _gather_policy_context,
    _run_hard_policy_checks,
    _run_policy_compliance,
)
from vertical_engines.credit.deep_review_pkg.decision import (
    _compute_confidence_score,
    _compute_decision_anchor,
)
from vertical_engines.credit.deep_review_pkg.prompts import (
...
def run_deal_deep_review_v4(
    ...
    *,
    ...
    from vertical_engines.credit.deep_review_pkg.confidence import (
