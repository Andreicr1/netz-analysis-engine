<!--
  Settings > Config — JSON config editor for private_credit vertical.
  Adapted from admin config page, hardcoded to private_credit.
-->
<script lang="ts">
...
{:else}
	<SectionCard title="Config Types">
		<EmptyState title="No config types" message="No config types found for private_credit." />
	</SectionCard>
{/if}
