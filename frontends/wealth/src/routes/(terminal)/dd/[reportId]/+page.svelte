...
<script lang="ts">
	...
	import { createTerminalStream } from "$lib/components/terminal/runtime/stream";
	...
	import DDChapterSection from "$lib/components/terminal/dd/DDChapterSection.svelte";
	import DDApprovalDialog from "$lib/components/terminal/dd/DDApprovalDialog.svelte";
	import type { DDReportFull, DDChapter, AuditEvent } from "$lib/types/dd-report";
